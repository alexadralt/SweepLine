...
public static class FaceWindingNumberComputer
{
    ...
    public static (List<FaceWithWindingNumber> InsideFaces, List<Segment> OuterFace) ComputeWindingNumbers(
        List<Segment> convolutionCycle, List<HalfEdge> halfEdges, bool onlyFacesWithZero = false)
    {
        ...
        foreach (var faceBoundary in new FaceBoundaryIterator(halfEdges))
        {
            ...
            while (true)
            {
                ...
                if (PointWindingNumberComputer.ComputeWindingNumber(faceBoundary, internalFacePoint, checkPointOnBoundary: true) > 0)
                {
                    break;
                }
            ...
            var windingNumber = PointWindingNumberComputer.ComputeWindingNumber(convolutionCycle, internalFacePoint);
